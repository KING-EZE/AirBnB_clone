...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        ...
        '''
        # checks if class name and instnace id was provided
        if line == "" or line is None:
            print("** class name missing **")

        else:
            # get all the agruments passed via the command line
    ...
    def do_destory(self, line):
        '''Usage: 1. destory <class name> <id> | 2. <class name>.delete(<id>)
        Function: Deletes the instance of the class
        '''
        # checks if class name and instance id was provided
        if line == "" or line is None:
            print("** class name missing **")

        else:
            # get all the agrugments passed via the command line
            class_info = line.split(" ")
            if len(class_info) < 2:
                print("** instance id missing **")
            else:
...
Function: Updates the instance of the class\
    ...
    def precmd(self, line):
        ...
        if args is None:
            ...
            # prints(args_checks.group(1), args_checks.group(2))
...
Function: Counts all the instance of the class
        '''
        count = 0
